...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<?php
		...
		{
			$q=mysqli_query($db,"SELECT first,last,username,roll,email,contact FROM `students` where username like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT first,last,username,roll,email,contact FROM `students`;");
