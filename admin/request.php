...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT students.username,roll,books.bid,name,authors,edition,status FROM students inner join issue_book ON
     students.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve =''";
